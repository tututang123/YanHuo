...
| 豆腐百科 2.5 / Tofu Encyclopedia 2.5 | `C:\Users\tutut\Downloads\豆腐百科2.5\豆腐百科2.5\豆腐2.5.exe` | 客户端改动说明、资料查询、修改心得参考 | 内置资料库 / 人工查看内容 | 改动说明、经验记录、参考信息 | Windows EXE，双击打开 | 不是主要编辑器。打开后把有用说明摘录到 `references/tofu-encyclopedia.md`。 |
...
- 是否需要管理员权限：未知
- 启动方式：双击 `豆腐2.5.exe`
- 主要用途：客户端改动说明、资料查询、修改心得记录来源
- 记录位置：`09-client-modding/references/tofu-encyclopedia.md`
- 已知限制：只作为资料和经验参考，不作为主要编辑工具
